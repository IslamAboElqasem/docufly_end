<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="GraduactionProject.emp_docufly.home" %>
...
<head>
    ...
    <link href="/emp_docufly/CSS/index.css" rel="stylesheet">
            ...
            <div class="row align-items-center text-center text-lg-end">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 my-5">
                    ...
                    <p>
                        ...
                        نهدف في كلية الحقوق بجامعة المنيا إلى تقديم تجربة تعليمية وإدارية متميزة من خلال هذه المنصة
                        الإلكترونية الشاملة. توفر المنصة وصولاً سهلاً إلى جميع المستندات والأوراق المطلوبة للطلاب
                        والموظفين، بما في ذلك:
                        <strong>الأوراق الإدارية: </strong> يمكنك من خلال المنصة الاطلاع على جميع المستندات اللازمة
                        لإجراءات القبول والتسجيل والخدمات الطلابية.
                        <strong>التقديمات الرسمية:</strong>متابعة حالة الطلبات الإدارية، مثل طلبات التظلمات، أو السحب،
                        أو التحويلات.
                        <strong>التحديثات والإشعارات:</strong>ابقَ على اطلاع دائم بجميع التحديثات الخاصة بالفعاليات
                        الأكاديمية، والمواعيد الهامة، والإعلانات.
                    </p>
                    <p>نهدف من خلال هذه المنصة إلى تسهيل العملية التعليمية والإدارية، وتقديم خدمة متكاملة ومتطورة لكل من
                        الطلاب والموظفين.</p>
                </div>
                <!-- صورة -->
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-header d-flex justify-content-between">
                        ...
                        <button type="button" class="btn-close mx-5" data-bs-dismiss="modal"
                    ...
                    <div class="modal-body my-5">
                        <form id="loginForm">
                            ...
                            <button type="submit" id="loginButton" class="btn btn-primary w-100" target="_self">تسجيل الدخول</button>
                        </form>
                    </div>
                </div>
            </div>
