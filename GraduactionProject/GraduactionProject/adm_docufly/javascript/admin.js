...
var deleteRow; // متغير لتخزين الصف الذي سيتم حذفه

function showDeleteModal(element) {
    deleteRow = element.closest('tr'); // حفظ الصف الذي سيتم حذفه
    var deleteModal = new bootstrap.Modal(document.getElementById('deleteModal')); // تفعيل الـ modal
    deleteModal.show(); // عرض الـ modal
}

document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
    if (deleteRow) {
        deleteRow.remove(); // حذف الصف
